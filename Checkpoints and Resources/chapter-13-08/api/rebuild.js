      ...
      if (process.env.NETLIFY_SITE_ID && process.env.COMMENTS_TOKEN) {
        ...
        if (deploys.ok) {
          ...
          if ( Array.isArray(list) &&
            ...
            const branches = ['chapter-11-03', 'chapter-11-04', 'chapter-11-05', 'chapter-12-01', 'chapter-12-02', 'chapter-12-03', 'chapter-12-04', 'chapter-12-05', 'chapter-12-06', "chapter-13-01", "chapter-13-02", "chapter-13-03", "chapter-13-04", "chapter-13-05", "chapter-13-06", "chapter-13-07", "chapter-13-08", "chapter-13-09",];
      ...
      if (process.env.GITHUB_ACCESS_TOKEN) {
        ...
        /** Changes for multiple branches in GitHub end **/
          const response = await fetch(
            `https://api.github.com/repos/hugoinaction/${repo}/actions/workflows/gh-pages.yml/runs`,
            {
              headers: {
          ...
          if (response.ok) {
            ...
            if (
              ...
              const rebuild = await fetch(
                `https://api.github.com/repos/hugoinaction/${repo}/actions/workflows/gh-pages.yml/dispatches`,
                {
                  method: "POST",
                  headers: {
                    Accept: "application/vnd.github.v3+json",
